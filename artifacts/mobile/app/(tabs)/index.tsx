    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { paddingTop: insets.top, backgroundColor: '#FFFFFF', borderBottomColor: colors.border }]}>
        <View style={styles.headerRow}>
          <Pressable style={styles.locationBtn} onPress={() => router.push('/(tabs)/explore')}>
      ...
      {isLoading ? (
        ...
        <FlatList
          ...
          ListFooterComponent={
            isFetchingNextPage ? <ActivityIndicator style={{ margin: 20 }} color="#FF3B30" /> : null
          }
          onEndReached={onEndReached}
          onEndReachedThreshold={0.5}
          refreshControl={<RefreshControl refreshing={isRefetching} onRefresh={refetch} tintColor="#FF3B30" />}
...
const styles = StyleSheet.create({
  ...
  locationText: { fontSize: 15, fontWeight: '700', color: '#2C2C2C' },
